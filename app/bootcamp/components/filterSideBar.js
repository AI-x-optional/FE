...
const FilterSidebar = ()=> {
    ...
    return (
    <div className="fixed top-100 w-64 bg-white p-4 shadow border-2 rounded-xl overflow-auto">
        <div className="space-y-6">
            ...
            <div>
                ...
                <div className="space-y-1">
                    <label className="flex items-center">
                        <input type="checkbox" className="form-checkbox h-4 w-4 mr-2" checked />
                        Back-end
                    </label>
                    <label className="flex items-center">
                        <input type="checkbox" className="form-checkbox h-4 w-4 mr-2" />
            ...
            <div>
                ...
                <label for="toggle" class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span  id="toggleText" class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                        {/* {isChecked ? 'On' : 'Off'} */}
                        </span>
                </label>
            </div>
