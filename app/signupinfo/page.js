...
import SignInfoButton from "./_components/signInfoButton";
...
export default function personlogin() {
    ...
    return(
        <>
            <div className="grid">
                <p className="text-xl p-2 align-middle font-bold justify-self-center mt-5 mb-2">추가 정보 입력</p>
                ...
                <button className="w-80 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded ml-2 justify-self-center"> 회원가입 완료 </button>
            </div>
        </>
    );
}